export default class EgoAudio {
	...
	constructor() {
		...
		$('#volume').on('input', (e) => {
			...
			gainNode.gainNode.value = fraction;

			//gainNode.gainNode.setValueAtTime(fraction, context.currentTime + 1);
			//gainNode.gainNode.value = volume;

			console.log(gainNode.gainNode.value);
